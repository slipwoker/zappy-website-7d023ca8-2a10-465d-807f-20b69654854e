    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Idron.co2 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7d023ca8-2a10-465d-807f-20b69654854e',
                    name: data.name || '',
                    email: data.email || '',
